 ...
 */
@Command(scope = "onos", name="mptcp-list-clear",
  description = "Clear mptcp initial connections list.")
public class MptcpConnectionListClearCommand extends AbstractShellCommand {

    @Override
    protected void execute() {
        MptcpConnectionService connectionService = getService(MptcpConnectionService.class);
        connectionService.clearMptcpConnections();
